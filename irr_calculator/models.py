...
class Security(Base):
    ...
    __table_args__ = (UniqueConstraint("provider", "symbol", name="uq_security_provider_symbol"),)
    id: Mapped[int] = mapped_column(primary_key=True)
...
class Quote(Base):
    ...
    __table_args__ = (
        UniqueConstraint("security_id", "provider", "market_date", name="uq_quote_security_day"),
