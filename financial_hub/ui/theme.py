...
def stylesheet() -> str:
    ...
    * {{ font-size: 13pt; color: {c["text"]}; }}
    ...
    QPushButton {{ min-height: 34px; padding: 3px 13px; border: 1px solid {c["border_strong"]}; border-radius: 6px; background: white; }}
    QPushButton:hover {{ border-color: {c["primary"]}; background: {c["hover"]}; }}
    ...
    QPushButton#danger:hover {{background: {c["danger-hover"]}; color: white}}
    ...
    QLineEdit, QComboBox, QDateEdit, QDoubleSpinBox {{ min-height: 34px; padding: 2px 8px; background: white; border: 1px solid {c["border"]}; border-radius: 6px; }}
    QSpinBox {{ min-height: 34px; padding: 2px 30px 2px 8px; background: white; border: 1px solid {c["border"]}; border-radius: 6px; }}
    QSpinBox::up-button,
    ...
    QTableView {{ background: white; alternate-background-color: #f8fafc; border: 1px solid {c["border_strong"]}; border-radius: 7px; gridline-color: {c["border"]}; }}
